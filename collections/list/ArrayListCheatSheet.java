 ...
 * It allows random access to elements and provides methods to manipulate
 ...
 *
 * Key Interfaces:
 * ArrayList implements the List interface, which extends the Collection
 * interface.
...
public class ArrayListCheatSheet {
    ...
    public static void main(String[] args) {
        // Creating an ArrayList using default constructor
